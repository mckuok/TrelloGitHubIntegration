...
public class RestApiConnectorTest {
	...
	public void getTest() throws IOException {
		...
		expectedObject.setBody("quia et suscipit\nsuscipit recusandae consequuntur expedita et cum\nreprehenderit molestiae ut ut quas totam\nnostrum rerum est autem sunt rem eveniet architecto");
		expectedObject.setTitle("sunt aut facere repellat provident occaecati excepturi optio reprehenderit");
		
		SampleJsonData returnedObject = RestApiConnector.get(root + "/posts/1", SampleJsonData.class);
