...
/**
 * This class contains library functions usefully for checking if arguments are
 * null. When writing methods, even for private methods, checkNull should be
 * used to make it clear that the argument cannot be null.
 * 
 * Created: Nov 3, 2016
 * 
